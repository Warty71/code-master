...
class _$WeatherModelImpl with DiagnosticableTreeMixin implements _WeatherModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'WeatherModel(lat: $lat, lon: $lon, weatherDescription: $weatherDescription, temperature: $temperature, feelsLike: $feelsLike, tempMin: $tempMin, tempMax: $tempMax, pressure: $pressure, humidity: $humidity)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, lat, lon, weatherDescription,
      temperature, feelsLike, tempMin, tempMax, pressure, humidity);
...
abstract class _WeatherModel implements WeatherModel {
  const factory _WeatherModel(
      ...
      required final int humidity}) = _$WeatherModelImpl;
